...
#define PanSource	"/Users/liusu1011/FIU/FIU12Spring/Energid/PIPE+/proModel.pml"
...
#define nstates1	13	/* :init: */
#define endstate1	12
short src_ln1 [] = {
	  0,  66,  67,  68,  69,  70,  71,  74, 
	 75,  76,  77,  78,  79,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "/Users/liusu1011/FIU/FIU12Spring/Energid/PIPE+/proModel.pml", 1, 12 },
	{ "-", 13, 14 }
};
uchar reached1 [] = {
	  0,   0,   0,   0,   0,   0,   0,   0, 
...
#define nstates0	26	/* Main */
#define endstate0	25
short src_ln0 [] = {
	  0,  35,  37,  39,  39,  40,  40,  40, 
	 38,  42,  42,  50,  44,  45,  46,  50, 
	 51,  51,  49,  53,  53,  61,  60,  63, 
	 60,  63,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "/Users/liusu1011/FIU/FIU12Spring/Energid/PIPE+/proModel.pml", 1, 25 },
	{ "-", 26, 27 }
};
uchar reached0 [] = {
	  0,   1,   0,   1,   0,   1,   1,   0, 
...
#define ASYNC	0
	...
	#endif
#endif
struct type_P0 { /* user defined type */
	short P0_field1;
	int P0_field2;
};
struct type_P1 { /* user defined type */
	short P1_field1;
	int P1_field2;
};
struct type_P2 { /* user defined type */
	short P2_field1;
};
char *procname[] = {
   "Main",
...
typedef struct P1 { /* :init: */
	...
	unsigned _p   : 6; /* state    */
	struct type_P0 _8_P0;
	struct type_P1 _8_P1;
	struct type_P2 _8_P2;
} P1;
#define Air1	0
...
typedef struct P0 { /* Main */
	...
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
	unsigned _7_T0_is_enabled : 1;
	struct type_P0 _7_P0;
	struct type_P1 _7_P1;
	struct type_P2 _7_P2;
} P0;
#define Air0	0
