...
public class FormulaPanel extends JPanel {
	...
	JButton btSetSubset = createButton('\u2282', curX, curY);
	curX += btSetSubset.getWidth();
	JButton btSetNotSubset = createButton('\u2284', curX, curY);
	curX += btSetNotSubset.getWidth();
	JButton btSetSubsetOrSet = createButton('\u2286', curX, curY);
