...
public class GuiFrame
   ...
   private AnimateAction startAction, stepforwardAction, stepbackwardAction,
           randomLowLevelAction, randomHighLevelAction, randomAnimateAction, modelCheckingAction;
...
//      zoomMenu.setIcon(new ImageIcon(GuiFrame.class.getResource("/Images/Zoom.png")));
      ...
      addMenuItem(animateMenu, modelCheckingAction =
          new AnimateAction("ModelChecking", Pipe.MODELCHECKING,
