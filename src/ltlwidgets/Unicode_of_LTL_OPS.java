...
public final class Unicode_of_LTL_OPS {
	...
	private Unicode_of_LTL_OPS() {
		...
		m_codes.add("" + RelGTEq);
		m_codes.add("" + RelLTEq);
		m_codes.add("" + ArithPlus);
		m_codes.add("" + ArithMinus);
		m_codes.add("" + ArithMult);
		m_codes.add("" + ArithMod);
		m_codes.add("" + ArithDiv);
		m_codes.add("" + FOLForAll);
		m_codes.add("" + FOLExists);
		m_codes.add("" + FOLNotExists);
		m_codes.add("" + FOLScope);
		m_codes.add("" + SetBelongs);
		m_codes.add("" + SetNotBelongs);
		m_codes.add("" + SetEmpty);
		m_codes.add("" + SetSubset);
		m_codes.add("" + SetNotSubset);
		m_codes.add("" + SetSubsetSet);
		m_codes.add("" + SetUnion);
		m_codes.add("" + SetDifference);
		m_codes.add("" + SetTupleSelL);
		m_codes.add("" + SetTupleSelR);
		// LTL
		m_codes.add("" + FLTLAlways);
		m_codes.add("" + FLTLSometimes);
		m_codes.add("" + FLTLNext);
		m_codes.add("" + FLTLUntil);
	...
	public static final char FLTLSometimes = '\uFA61'; // sym.FLTL_SOMETIMES //
														// Eventually
	public static final char FLTLNext = '\uFA62'; // sym.FLTL_NEXT // Next
	public static final char FLTLUntil = '\uFA63'; // sym.FLTL_UNTIL // Until
	public static final char FLTLWkUntil = '\uFA64'; // sym.FLTL_WKUNTIL // Weak
														// Until
