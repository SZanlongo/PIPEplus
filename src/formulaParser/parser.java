...
public class parser extends java_cup.runtime.lr_parser {
    ...
    /** Production table. */
    protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\075\000\002\002\004\000\002\002\003\000\002\003"
    ...
    /** Parse-action table. */
    protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\152\000\034\006\012\020\030\024\005\025\032\026"
    ...
    protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\152\000\036\002\020\003\003\004\034\005\005\006"
...
class CUP$parser$actions {
	...
	case 45: // variable ::= ID LBRACK index RBRACK
	{
	    ...
	    Index idx = (Index) ((java_cup.runtime.Symbol) CUP$parser$stack
	...
	case 43: // set_exp ::= LBRACE LBRACK terms RBRACK RBRACE
	{
	    ...
	    Terms ts = (Terms) ((java_cup.runtime.Symbol) CUP$parser$stack
	...
	case 42: // set_exp ::= LBRACE term RBRACE
	{
	    ...
	    Term t = (Term) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).value;
	...
	{
	    SetExp RESULT = null;
	    Term t1 = (Term) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 2)).value;
	...
	case 24: // exp ::= set_exp
	{
	    ...
	    SetExp se = (SetExp) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 23: // exp ::= rel_exp
	{
	    ...
	    RelExp re = (RelExp) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 22: // exp ::= arith_exp
	{
	    ...
	    ArithExp ae = (ArithExp) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 21: // termRests ::= termRests termRest
	{
	    ...
	    TermRestList trs = (TermRestList) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).value;
	    TermRest tr = (TermRest) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	    trs.addElement(tr);
	    RESULT = trs;
	    CUP$parser$result = parser
	...
	case 18: // terms ::= term termRests
	{
	    ...
	    Term t = (Term) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).value;
	    TermRestList tr = (TermRestList) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 16: // term ::= empty
	{
	    Term RESULT = null;
	    int eleft = ((java_cup.runtime.Symbol) CUP$parser$stack.peek()).left;
	    Empty e = (Empty) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 15: // term ::= variable
	{
	    ...
	    Variable v = (Variable) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 14: // term ::= constant
	{
	    ...
	    Constant c = (Constant) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 13: // message ::= channelName messageOp LBRACK terms RBRACK
	{
	    ...
	    /* . . . . . . . . . . . . . . . . . . . . */
	case 12: // complexFormula ::= quantifier userVariable domain variable
		 // DOT LPAREN formula RPAREN
	{
	    ComplexFormula RESULT = null;
	    int qleft = ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 7)).left;
	    Quantifier q = (Quantifier) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 7)).value;
	    UserVariable u = (UserVariable) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 6)).value;
	    Domain d = (Domain) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 5)).value;
	    Variable v = (Variable) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 4)).value;
	    Formula f = (Formula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).value;
	...
	{
	    CompoundFormula RESULT = null;
	    Formula f1 = (Formula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 2)).value;
	    int eleft = ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).left;
	    Formula f2 = (Formula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 4: // formula ::= complexFormula
	{
	    ...
	    ComplexFormula cpf = (ComplexFormula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 3: // formula ::= compoundFormula
	{
	    ...
	    CompoundFormula cf = (CompoundFormula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	case 2: // formula ::= atomicFormula
	{
	    ...
	    AtomicFormula af = (AtomicFormula) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .peek()).value;
	...
	{
	    Object RESULT = null;
	    Sentence start_val = (Sentence) ((java_cup.runtime.Symbol) CUP$parser$stack
		    .elementAt(CUP$parser$top - 1)).value;
	    RESULT = start_val;
	    CUP$parser$result = parser
		    .getSymbolFactory()
