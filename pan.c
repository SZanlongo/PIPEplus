...
/*** From source: /Users/liusu1011/FIU/FIU12Spring/Energid/PIPE+/proModel.pml ***/
...
{	int j, h = now._nr_pr;
	...
	case 1:	/* :init: */
		...
		/* params: */
		/* locals: */
		((P1 *)pptr(h))->_8_P0.P0_field1 = 0;
		((P1 *)pptr(h))->_8_P0.P0_field2 = 0;
		((P1 *)pptr(h))->_8_P1.P1_field1 = 0;
		((P1 *)pptr(h))->_8_P1.P1_field2 = 0;
		((P1 *)pptr(h))->_8_P2.P2_field1 = 0;
#ifdef VAR_RANGES
		logval(":init::_8_P0.P0_field1", ((P1 *)pptr(h))->_8_P0.P0_field1);
		logval(":init::_8_P0.P0_field2", ((P1 *)pptr(h))->_8_P0.P0_field2);
		logval(":init::_8_P1.P1_field1", ((P1 *)pptr(h))->_8_P1.P1_field1);
		logval(":init::_8_P1.P1_field2", ((P1 *)pptr(h))->_8_P1.P1_field2);
		logval(":init::_8_P2.P2_field1", ((P1 *)pptr(h))->_8_P2.P2_field1);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* Main */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_7_T0_is_enabled = 0;
		((P0 *)pptr(h))->_7_P0.P0_field1 = 0;
		((P0 *)pptr(h))->_7_P0.P0_field2 = 0;
		((P0 *)pptr(h))->_7_P1.P1_field1 = 0;
		((P0 *)pptr(h))->_7_P1.P1_field2 = 0;
		((P0 *)pptr(h))->_7_P2.P2_field1 = 0;
#ifdef VAR_RANGES
		logval("Main:T0_is_enabled", ((P0 *)pptr(h))->_7_T0_is_enabled);
		logval("Main:_7_P0.P0_field1", ((P0 *)pptr(h))->_7_P0.P0_field1);
		logval("Main:_7_P0.P0_field2", ((P0 *)pptr(h))->_7_P0.P0_field2);
		logval("Main:_7_P1.P1_field1", ((P0 *)pptr(h))->_7_P1.P1_field1);
		logval("Main:_7_P1.P1_field2", ((P0 *)pptr(h))->_7_P1.P1_field2);
		logval("Main:_7_P2.P2_field1", ((P0 *)pptr(h))->_7_P2.P2_field1);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
	...
	if ((Maxbody % WS) != 0)
		...
		now.place_P0 = addqueue(calling_pid, 1, 1);
		now.place_P1 = addqueue(calling_pid, 2, 1);
		now.place_P2 = addqueue(calling_pid, 3, 1);
#ifdef VAR_RANGES
#endif
}
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.place_P0) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.place_P0) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.place_P0) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.place_P0) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.place_P1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.place_P1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.place_P1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.place_P1) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.place_P2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.place_P2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.place_P2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.place_P2) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	chan place_P0 (=%d):	len %d:\t", now.place_P0, q_len(now.place_P0));
	c_chandump(now.place_P0);
	printf("	chan place_P1 (=%d):	len %d:\t", now.place_P1, q_len(now.place_P1));
	c_chandump(now.place_P1);
	printf("	chan place_P2 (=%d):	len %d:\t", now.place_P2, q_len(now.place_P2));
	c_chandump(now.place_P2);
}
void
...
{	/* int i; */
	...
	case 1:
		...
		printf("	(struct _8_P0)\n");
	printf("	short  P0_field1:	%d\n", ((P1 *)pptr(pid))->_8_P0.P0_field1);
	printf("	int    P0_field2:	%d\n", ((P1 *)pptr(pid))->_8_P0.P0_field2);
		printf("	(struct _8_P1)\n");
	printf("	short  P1_field1:	%d\n", ((P1 *)pptr(pid))->_8_P1.P1_field1);
	printf("	int    P1_field2:	%d\n", ((P1 *)pptr(pid))->_8_P1.P1_field2);
		printf("	(struct _8_P2)\n");
	printf("	short  P2_field1:	%d\n", ((P1 *)pptr(pid))->_8_P2.P2_field1);
		break;
	case 0:
		printf("local vars proc %d (Main):\n", pid);
	printf("	bit    T0_is_enabled:	%d\n", ((P0 *)pptr(pid))->_7_T0_is_enabled);
		printf("	(struct _7_P0)\n");
	printf("	short  P0_field1:	%d\n", ((P0 *)pptr(pid))->_7_P0.P0_field1);
	printf("	int    P0_field2:	%d\n", ((P0 *)pptr(pid))->_7_P0.P0_field2);
		printf("	(struct _7_P1)\n");
	printf("	short  P1_field1:	%d\n", ((P0 *)pptr(pid))->_7_P1.P1_field1);
	printf("	int    P1_field2:	%d\n", ((P0 *)pptr(pid))->_7_P1.P1_field2);
		printf("	(struct _7_P2)\n");
	printf("	short  P2_field1:	%d\n", ((P0 *)pptr(pid))->_7_P2.P2_field1);
		break;
	}
}
void
